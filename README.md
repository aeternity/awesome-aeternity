...
- [Superhero](https://superhero.com) - A user-centric, open source, decentralized - P2P social platform that elevates the impact of communities and user generated content with the help of blockchain technology.
    ...
    - Articles:
        ...
        - [https://kryptokrauts.com/log/superhero-a-truly-decentralized-social-tipping-platform](https://github.com/kryptokrauts/kk-website/blob/master/src/data/log/2020-06-14-superhero-a-truly-decentralized-tipping-platform.md)
